...
<div id="main">
    <div class="container">
        <div class="row">
            <h1>Captcha bypass 1</h1>
        </div>
        <div class="row">
            <p class="lead">
                Flag is an integer between 1000 and 2000.<br />
            </p>
        </div>
    </div>
</div>
<div class="container">
    ...
    if(isset ($_POST['submit'])){
        if (isset($_POST["captcha"]) ){
            if($_SESSION["code"]!==(int)$_POST["captcha"]){
        ...
        if (isset ($_POST['flag'])) {
            ...
            if ($user_flag==$flag) {
                ...
                echo "<button onclick=\"window.location.href='../captcha2/'\">Next challenge -></button></p>";
            }
            else{
